...
@Injectable()
export class UserExpenseReportsService implements ResetableService {
    ...
    madeByEmailFilter: string = null;
    madeByNameFilter: string = null;
    madeBySurnameFilter: string = null;
    ...
    resetFilters() {
        ...
        this.madeByEmailFilter = null;
        this.madeByNameFilter = null;
        this.madeBySurnameFilter = null;
    }
    ...
    private loadMyExpenseReportsCall(predicate: SPredicate): Observable<any> {
        ...
        return this.datasource.sendGetRequest<GenericResponse<Page<ExpenseReportDTO>>>(
            this.backendUrlsSrv.getFindAllUserExpenseReportsUrl(), predicate.params, true
        ).pipe(
            map(
    ...
    private buildFilters(): QueryParameter[] {
        ...
        this.predicateBuider.addStringQueryParamForFilter("madeByEmail", this.madeByEmailFilter, queryParameters);
        this.predicateBuider.addStringQueryParamForFilter("madeByName", this.madeByNameFilter, queryParameters);
        this.predicateBuider.addStringQueryParamForFilter("madeBySurname", this.madeBySurnameFilter, queryParameters);
